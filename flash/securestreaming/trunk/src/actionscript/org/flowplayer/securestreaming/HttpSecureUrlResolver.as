...
import flash.events.NetStatusEvent;
    ...
    public class HttpSecureUrlResolver implements ClipURLResolver {
        ...
        public function HttpSecureUrlResolver(player:Flowplayer, config:Config, failureListener:Function) {
            _player = player;
            _config = config;
