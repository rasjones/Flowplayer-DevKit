package at.vol.carousel
{
	...
	*/
	public class CustomBitmapFileMaterial extends BitmapMaterial implements ITriangleDrawer
	{
		...
		*/
		override public function set texture( asset:Object ):void
		{
			...
			} else if( asset is String)
			{
				...
				PaperLogger.error("BitmapFileMaterial.texture requires a String or BitmapData for the texture");
				return;
			}
		...
		*/
		public function CustomBitmapFileMaterial( url :String="", precise:Boolean=false )
		{
		...
		*/
		...
		protected function loadBitmapCompleteHandler( e:Event ):void
		{
			...
			for each( var material:CustomBitmapFileMaterial in _subscribedMaterials[ url ] )
			{
				material.bitmap = bmp;
	...
	// ___________________________________________________________________ SET UP ASYNCHRONOUS LOAD COMPLETE CALLBACK
		...
		protected function getBitmapForFilename(filename:String) : BitmapData
		{
			...
			{
				var bfm : CustomBitmapFileMaterial = ref as CustomBitmapFileMaterial; 
